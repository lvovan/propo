...
- **WelcomePage** (unauthenticated): `[ Propo! ]  ···  [ language-switcher ]`
- **MainPage** (authenticated): `[ Propo!  🐱  Hi, Name! ]  ···  [ language-switcher  Switch player ]`
...
2. Open the app — the WelcomePage should show a horizontal header bar with "Propo!" on the left and the language switcher on the right
3. Create a player and start a session — the MainPage header should show "Propo!" + avatar + greeting on the left, language switcher + "Switch player" on the right
