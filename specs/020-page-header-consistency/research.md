...
**Decision**: Show "Propo!" on both pages, inline in the left section of the header bar.

- WelcomePage (unauthenticated): `[ Propo! ]  ...  [ lang-switcher ]`
- MainPage (authenticated): `[ Propo!  avatar  Hi, Name! ]  ...  [ lang-switcher  Switch player ]`
