...
> **⚠️ DEPRECATED**: This contract is no longer applicable. The core gameplay was reworked in March 2026 to test proportional reasoning instead of multiplication tables. See 002-core-gameplay/contracts/formula-generator.md for the current contract.
