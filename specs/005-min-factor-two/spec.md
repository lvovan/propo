...
> **⚠️ DEPRECATED**: This specification is no longer applicable. The core gameplay was reworked in March 2026 to test proportional reasoning (percentages, ratios, fractions, rule-of-three word problems) instead of multiplication tables. The concept of "factor range 2–12" is superseded by the new question generation pools in 002-core-gameplay. This file is retained for historical reference only.

**Feature Branch**: `005-min-factor-two`  
**Created**: 2026-02-16  
**Status**: Deprecated (2026-03-06)  
