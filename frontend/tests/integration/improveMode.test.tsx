...
function createGameWithChallengingPairs(playerName: string) {
  const rounds: RoundResult[] = [
    { type: 'percentage', values: [25, 80, 20], isCorrect: false, elapsedMs: 8000 },
    { type: 'ratio', values: [2, 3, 6, 9], isCorrect: false, elapsedMs: 7000 },
    { type: 'percentage', values: [10, 30, 3], isCorrect: true, elapsedMs: 1000 },
    { type: 'fraction', values: [1, 3, 2, 6], isCorrect: true, elapsedMs: 1200 },
    { type: 'percentage', values: [50, 10, 5], isCorrect: true, elapsedMs: 900 },
    { type: 'ratio', values: [3, 5, 6, 10], isCorrect: true, elapsedMs: 1100 },
    { type: 'percentage', values: [20, 40, 8], isCorrect: true, elapsedMs: 800 },
    { type: 'fraction', values: [2, 5, 4, 10], isCorrect: true, elapsedMs: 1000 },
    { type: 'percentage', values: [10, 90, 9], isCorrect: true, elapsedMs: 950 },
    { type: 'percentage', values: [25, 40, 10], isCorrect: true, elapsedMs: 1050 },
  ];
...
describe('Improve Mode — Multi-Game Tricky Numbers', () => {
  ...
  it('aggregates tricky pairs across multiple game records for Practice mode', async () => {
    ...
    const rounds1: RoundResult[] = [
      ...
      { type: 'percentage', values: [10, 90, 9], isCorrect: true, elapsedMs: 950 },
      { type: 'percentage', values: [25, 40, 10], isCorrect: true, elapsedMs: 1050 },
      { type: 'ratio', values: [2, 7, 4, 14], isCorrect: true, elapsedMs: 1100 },
    ];
    saveGameRecord('MultiGamePlayer', 25, rounds1, 'play');

    // Game 2: mistake on percentage again and ratio
    const rounds2: RoundResult[] = [
      { type: 'percentage', values: [25, 80, 20], isCorrect: false, elapsedMs: 7000 },
      { type: 'ratio', values: [2, 3, 6, 9], isCorrect: false, elapsedMs: 6000 },
      { type: 'percentage', values: [10, 30, 3], isCorrect: true, elapsedMs: 1000 },
      { type: 'fraction', values: [1, 3, 2, 6], isCorrect: true, elapsedMs: 1200 },
      { type: 'percentage', values: [50, 10, 5], isCorrect: true, elapsedMs: 900 },
      { type: 'ratio', values: [3, 5, 6, 10], isCorrect: true, elapsedMs: 1100 },
