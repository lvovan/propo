...
export interface RoundResult {
  /** Which question category this round used. */
  type: QuestionType;
  /** The values array from the formula (for challenge analysis). */
  values: number[];
...
/** Top-level object persisted in localStorage under key "propo_players". */
