...
const de: Dictionary = {
  ...
  'game.pointSingular': 'Punkt',
  'game.pointPlural': 'Punkte',
  ...
  'mode.competition': 'Wettbewerb',
  'mode.competitionDesc': 'Fordere einen Freund heraus!',
  'mode.competitionAriaLabel': 'Wettbewerb — Fordere einen Freund heraus!',
  'competition.seedInputLabel': 'Spielschlüssel',
  'competition.seedPlaceholder': 'Schlüssel eingeben oder generieren',
  'competition.generateSeed': 'Schlüssel generieren',
  'competition.startGame': 'Spiel starten',
  'competition.back': 'Zurück',
  'competition.totalTime': 'Gesamtzeit',
  'competition.seed': 'Schlüssel',
  'competition.share': 'Ergebnis teilen',
  'competition.shareCopied': 'Link kopiert!',
  'sharedResult.title': 'Wettbewerb-Ergebnis',
  'sharedResult.playThisGame': 'Dieses Spiel spielen',
  'sharedResult.score': 'Punktzahl',
  'sharedResult.time': 'Zeit',
  'sharedResult.player': 'Spieler',
  'sharedResult.error': 'Dieser Ergebnislink ist ungültig oder unvollständig.',
  ...
  'scores.excludingCompetition': 'ohne Wettbewerbsspiele',
