...
const en = {
  ...
  'story.complexExtrapolation.space': 'On a space mission, if {a} astronauts need {b} oxygen tanks, how many tanks do {c} astronauts need?',
  'story.complexExtrapolation.camping': 'At a campsite, if {a} campers need {b} tent pegs, how many pegs do {c} campers need?',
  'story.complexExtrapolation.baking': 'In a bakery, if {a} cakes need {b} eggs, how many eggs do {c} cakes need?',
  'story.complexExtrapolation.travel': 'On a road trip, if {a} cars use {b} litres of fuel, how many litres do {c} cars use?',
  'story.complexExtrapolation.sports': 'At a tournament, if {a} teams need {b} balls, how many balls do {c} teams need?',
  'story.complexExtrapolation.school': 'In art class, if {a} students need {b} paintbrushes, how many brushes do {c} students need?',
